package com.crondit.weatherapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void api_key(final String City) {
        ...
        Request request = new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=f29caaff3cb435c8dbf5c63b93cf9acc")
                .get()
                .build();
    ...
    private void setImage(final ImageView imageView, final String value){
        ...
        switch (value){
            ...
            case "04n": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon4));
                break;
            case "05d": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon5));
                break;
            case "05n": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon5));
                break;
            case "06d": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon6));
                break;
            case "06n": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon6));
                break;
            case "07d": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon7));
                break;
            case "07n": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon7));
                break;
            default: view_weather.setImageDrawable(getResources().getDrawable(R.drawable.weather));
